        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('employees.create') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" id="hire_date" name="hire_date" required>
